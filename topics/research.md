# Направление 6. Исследования

Сбор и проверка информации: веб, конкуренты, соцсети, расшифровки. Все навыки —
спутники из открытых источников (см. CATALOG.md).

## Спутники

- `perplexity-research` (agentos) — веб-ресёрч с источниками.
- `transcript` (agentos) — расшифровки YouTube.
